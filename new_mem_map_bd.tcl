...
################################################################
# This is a generated script based on design: new_mem_map
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set sw1_h [ create_bd_port -dir O sw1_h ]
  set sw1_l [ create_bd_port -dir O sw1_l ]
  set sw2_h [ create_bd_port -dir O sw2_h ]
  set sw2_l [ create_bd_port -dir O sw2_l ]
  set sw3_h [ create_bd_port -dir O sw3_h ]
  set sw3_l [ create_bd_port -dir O sw3_l ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_gpio_pwm/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net Pwm_1_sw1_h [get_bd_ports sw1_h] [get_bd_pins Pwm_1/sw1_h]
  connect_bd_net -net Pwm_1_sw1_l [get_bd_ports sw1_l] [get_bd_pins Pwm_1/sw1_l]
  connect_bd_net -net Pwm_1_sw2_h [get_bd_ports sw2_h] [get_bd_pins Pwm_1/sw2_h]
  connect_bd_net -net Pwm_1_sw2_l [get_bd_ports sw2_l] [get_bd_pins Pwm_1/sw2_l]
  connect_bd_net -net Pwm_1_sw3_h [get_bd_ports sw3_h] [get_bd_pins Pwm_1/sw3_h]
  connect_bd_net -net Pwm_1_sw3_l [get_bd_ports sw3_l] [get_bd_pins Pwm_1/sw3_l]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_pwm/gpio_io_o] [get_bd_pins dead_band/Din] [get_bd_pins duty_ratio/Din]
  connect_bd_net -net dead_band_Dout [get_bd_pins Pwm_1/band_i] [get_bd_pins dead_band/Dout]
  connect_bd_net -net duty_ratio_Dout [get_bd_pins Pwm_1/duty_i] [get_bd_pins duty_ratio/Dout]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_pwm/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Pwm_1/clk_i] [get_bd_pins axi_gpio_pwm/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
